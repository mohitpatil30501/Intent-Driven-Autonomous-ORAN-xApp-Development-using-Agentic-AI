...
INSERT INTO `AccessAndMobilitySubscriptionData` (`ueid`, `servingPlmnid`, `nssai`, `subscribedUeAmbr`) VALUES
('001010000000101', '00101', '{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}], \"singleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}', '{\"uplink\": \"1Gbps\", \"downlink\": \"2Gbps\"}');
INSERT INTO `AccessAndMobilitySubscriptionData` (`ueid`, `servingPlmnid`, `nssai`, `subscribedUeAmbr`) VALUES
('001010000000102', '00101', '{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}], \"singleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}', '{\"uplink\": \"1Gbps\", \"downlink\": \"2Gbps\"}');
INSERT INTO `AccessAndMobilitySubscriptionData` (`ueid`, `servingPlmnid`, `nssai`, `subscribedUeAmbr`) VALUES
('001010000000103', '00101', '{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}], \"singleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}', '{\"uplink\": \"1Gbps\", \"downlink\": \"2Gbps\"}');
INSERT INTO `AccessAndMobilitySubscriptionData` (`ueid`, `servingPlmnid`, `nssai`, `subscribedUeAmbr`) VALUES
('001010000000104', '00101', '{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}], \"singleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}', '{\"uplink\": \"1Gbps\", \"downlink\": \"2Gbps\"}');
-- --------------------------------------------------------
...
('001010000000101', '00101', '{\"sst\": 1, \"sd\": \"000001\"}',
 '{
    \"oai\": {
        ...
        \"sessionAmbr\": {\"uplink\": \"200Mbps\", \"downlink\": \"100Mbps\"}
    }
  }'
);

INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('001010000000102', '00101', '{\"sst\": 1, \"sd\": \"000001\"}',
 '{
    \"oai\": {
        \"pduSessionTypes\": {\"defaultSessionType\": \"IPV4\", \"allowedSessionTypes\": [\"IPV4\"]},
        \"sscModes\": {\"defaultSscMode\": \"SSC_MODE_1\", \"allowedSscModes\": [\"SSC_MODE_1\", \"SSC_MODE_2\", \"SSC_MODE_3\"]},
...
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('001010000000103', '00101', '{\"sst\": 1, \"sd\": \"000001\"}',
 '{
    \"oai\": {
        \"pduSessionTypes\": {\"defaultSessionType\": \"IPV4\", \"allowedSessionTypes\": [\"IPV4\"]},
        \"sscModes\": {\"defaultSscMode\": \"SSC_MODE_1\", \"allowedSscModes\": [\"SSC_MODE_1\", \"SSC_MODE_2\", \"SSC_MODE_3\"]},
...
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('001010000000104', '00101', '{\"sst\": 1, \"sd\": \"000001\"}',
 '{
    \"oai\": {
        \"pduSessionTypes\": {\"defaultSessionType\": \"IPV4\", \"allowedSessionTypes\": [\"IPV4\"]},
        \"sscModes\": {\"defaultSscMode\": \"SSC_MODE_1\", \"allowedSscModes\": [\"SSC_MODE_1\", \"SSC_MODE_2\", \"SSC_MODE_3\"]},
...
-- If you want this UE to get a specific static IP for DNN "oai":
-- ,"staticIpAddress": [{"ipv4Addr": "12.1.1.10"}] # Ensure this IP is in your SMF's pool for DNN "oai"
